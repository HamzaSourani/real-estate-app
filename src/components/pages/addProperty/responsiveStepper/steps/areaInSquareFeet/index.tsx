    ...
    <Grid container spacing={2}>
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="sqft_living"
          type="number"
          label={t("pages.add-property.form-fields.sqft-living")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="sqft_living_15"
          type="number"
          label={t("pages.add-property.form-fields.sqft-living-15")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="sqft_lot"
          type="number"
          label={t("pages.add-property.form-fields.sqft-lot")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          ...
          type="number"
          label={t("pages.add-property.form-fields.sqft-lot-15")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="sqft_above"
          type="number"
          label={t("pages.add-property.form-fields.above")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="sqft_basement"
          type="number"
          label={t("pages.add-property.form-fields.basement")}
          fullWidth
