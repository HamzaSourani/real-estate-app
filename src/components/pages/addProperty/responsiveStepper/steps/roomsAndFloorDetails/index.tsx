    ...
    <Grid container spacing={2}>
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="bed_rooms"
          type="number"
          label={t("pages.add-property.form-fields.bedrooms")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="bath_rooms"
          type="number"
          label={t("pages.add-property.form-fields.bathrooms")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="kitchens"
          type="number"
          label={t("pages.add-property.form-fields.kitchens")}
          fullWidth
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="floors"
          type="number"
          label={t("pages.add-property.form-fields.floors")}
          fullWidth
          value={values.floors}
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          name="floor_level"
          type="number"
          label={t("pages.add-property.form-fields.floor-level")}
          fullWidth
